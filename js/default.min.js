    ...
    if ($j('header.page_header').hasClass('fixed')) {
        ...
        if (header_one_scroll_resize) {
            if ($scroll > $top_header_height + 200) {
                ...
                $j('header .side_menu_button_wrapper .side_menu_button a.search_icon_bckg_full').css({
                    'line-height': min_header_height_scroll + large_menu_item_border + 'px'
                });
    ...
    if ($j('.carousel').length) {
        ...
        $j('.carousel').each(function() {
                ...
                $j('.slider_content_outer.content_bottom_left, .slider_content_outer.content_bottom_right').each(function() {
                    if (typeof $j(this).find('.slider_content').data('resize') !== 'undefined') {
                        ...
                        if ($j(window).width() < 1350 && $j(window).width() > 1000) {
                            slider_content.css({
                                "width": resized_slider_content_width + 'px'
                            })
                        } else {
                            slider_content.css({
                                "width": initial_slider_content_width + 'px'
                            })
                        }
                        $j(window).resize(function() {
                            if ($j(window).width() < 1350 && $j(window).width() > 1000) {
            ...
            function setSliderElementsSize($item, i) {
                ...
                $item.find('.mkd_slide_subtitle').css({
                ...
                $item.find('.separator_content').css({
                    "font-size": Math.round(window["slider_text_separator_" + i][0] * slider_text_coefficient) + 'px'
                });
                $item.find('.separator_content').css({
                    "line-height": Math.round(window["slider_text_separator_" + i][1] * slider_text_coefficient) + 'px'
                });
                $item.find('.separator_content').css({
                    "letter-spacing": Math.round(window["slider_text_separator_" + i][2] * slider_text_coefficient_letter_spacing) + 'px'
                });
                $item.find('.mkd_line_before').css({
                    "width": Math.round(window["slider_text_separator_width_" + i][0] * slider_text_coefficient) + 'px'
                });
                $item.find('.mkd_line_after').css({
                    "width": Math.round(window["slider_text_separator_width_" + i][0] * slider_text_coefficient) + 'px'
                });
                ...
                $item.find('.separator_top').css({
                    "margin-top": Math.round(window["slider_top_separator_" + i][0] * slider_title_coefficient) + 'px'
                });
                $item.find('.separator_top').css({
                    "margin-bottom": Math.round(window["slider_top_separator_" + i][1] * slider_title_coefficient) + 'px'
                });
                $item.find('.separator_bottom').css({
                    "margin-top": Math.round(window["slider_bottom_separator_" + i][0] * slider_title_coefficient) + 'px'
                });
                $item.find('.separator_bottom').css({
                    "margin-bottom": Math.round(window["slider_bottom_separator_" + i][1] * slider_title_coefficient) + 'px'
                })
            }
            ...
            function resetSliderElementsSize($item, i) {
                ...
                $item.find('.separator_content').css({
                    "font-size": Math.round(window["slider_text_separator_" + i][0]) + 'px'
                });
                $item.find('.separator_content').css({
                    "line-height": Math.round(window["slider_text_separator_" + i][1]) + 'px'
                });
                $item.find('.separator_content').css({
                    "letter-spacing": Math.round(window["slider_text_separator_" + i][2]) + 'px'
                });
                $item.find('.mkd_line_before').css({
                    "width": Math.round(window["slider_text_separator_width_" + i][0]) + 'px'
                });
                $item.find('.mkd_line_after').css({
                    "width": Math.round(window["slider_text_separator_width_" + i][0]) + 'px'
                });
                ...
                $item.find('.separator_top').css({
                    "margin-top": Math.round(window["slider_top_separator_" + i][0]) + 'px'
                });
                $item.find('.separator_top').css({
                    "margin-bottom": Math.round(window["slider_top_separator_" + i][1]) + 'px'
                });
                $item.find('.separator_bottom').css({
                    "margin-top": Math.round(window["slider_bottom_separator_" + i][0]) + 'px'
                });
                $item.find('.separator_bottom').css({
                    "margin-bottom": Math.round(window["slider_bottom_separator_" + i][1]) + 'px'
                })
            }
    ...
    if ($j('.mkd_carousels').length) {
        $j('.mkd_carousels').each(function() {
            ...
            $j(this).find('.slides').carouFredSel({
                ...
                onCreate: function() {
                    $j(this).css('display', 'block').animate({
                        'opacity': 1
                    }, 1000, function() {
                        if ($j('.widget_sticky-sidebar').length) {
                            widgetTopOffset = $j('.widget_sticky-sidebar').offset().top;
    ...
    if ($j('.no-touch .vertical_menu').hasClass('click')) {
        ...
        menu_items.each(function(i) {
            if ($j(menu_items[i]).parent().hasClass('has_sub')) {
                ...
                var link = $j("<a />", {
                    "href": menu_url,
                    "html": '<i class="mkd_menu_arrow fa fa-angle-left"></i>' + menu_text
                }).appendTo(li);
...
function initFlexSlider() {
    ...
    $j('.flexslider').each(function() {
            ...
            start: function() {
                ...
                if (bulletsStyle !== "") {
                    if ($this.find('.flex-control-paging a').length) {
                        $this.find('.flex-control-paging a').attr('style', function() {
                            return bulletsStyle
                        })
                    }
                }
                if (bulletsActiveStyle !== "") {
                    if ($this.find('.flex-control-paging a.flex-active').length) {
                        $this.find('.flex-control-paging a.flex-active').attr('style', function() {
                            return bulletsActiveStyle
                        })
                    }
                }
                var top_margin = 0;
                ...
                $this.find('.flex-direction-nav a').each(function() {
                    ...
                    $j(this).css({
                        'margin-left': '-' + left_right_margin + 'px'
                    });
                    $j(this).css({
                        'margin-right': '-' + left_right_margin + 'px'
                    });
                    $j(this).css({
                        'opacity': '1'
                    })
        ...
        if (arrowsColor !== '' || arrowsHoverColor !== '') {
            ...
            $this.find('.flex-direction-nav a').hover(function() {
    ...
    if ($j('.mkd_message').length) {
        $j('.mkd_message').each(function() {
            ...
            if (typeof $j(this).data('close-hover-color') !== 'undefined' && $j(this).data('close-hover-color') !== false) {
                ...
                $j(this).find('.icon_close').hover(function() {
        ...
        $j('.mkd_progress_bars_icons_holder').each(function() {
            ...
            $this.appear(function() {
                ...
                $this.find('.mkd_progress_bars_icons').each(function() {
                    ...
                    if (size !== "") {
                        $j(this).find('.mkd_progress_bars_icons_inner.custom_size .bar').css({
                            'width': size + 'px',
                            'height': size + 'px'
                        });
...
function initMoreFacts() {
    ...
    if ($j('.more_facts_holder').length) {
        $j('.more_facts_holder').each(function() {
            ...
            $this.find('.more_facts_inner_holder').css({
                'height': '0px',
                'display': 'none',
                'opacity': '0'
            });
        ...
        if ($j('header.page_header').hasClass('fixed') && !$j('body').hasClass('vertical_menu_enabled')) {
            ...
            if (!$j('header.page_header').hasClass('transparent') || $j('header.page_header').hasClass('scrolled_not_transparent')) {
                if ($j('[data-mkd_id="' + hash + '"]').offset().top - (header_height + logo_height / 2 + 20) <= scroll_amount_for_fixed_hiding) {
                    scrollToAmount = $j('[data-mkd_id="' + hash + '"]').offset().top - header_height - logo_height / 2 - 20 - paspartuScrollAdd
                } else {
                    scrollToAmount = $j('[data-mkd_id="' + hash + '"]').offset().top - min_header_height_fixed_hidden - 20 - paspartuScrollAdd
                }
            } else {
                scrollToAmount = $j('[data-mkd_id="' + hash + '"]').offset().top - paspartuScrollAdd
            }
            ...
            if (!$j('header.page_header').hasClass('transparent') || $j('header.page_header').hasClass('scrolled_not_transparent')) {
                if (sticky_amount >= $j('[data-mkd_id="' + hash + '"]').offset().top) {
                    scrollToAmount = $j('[data-mkd_id="' + hash + '"]').offset().top + 1 - paspartuScrollAdd
                } else {
        ...
        $j('.search_slides_from_window_top ').click(function(e) {
            ...
            if ($j('html').hasClass('touch')) {
                ...
                if ($j('.mkd_search_form').height() == "0") {
                    ...
                    $j('.mkd_search_form').stop().animate({
                        height: "50px"
                    }, 150);
        ...
        if ($j('header.page_header').hasClass('fixed') && !$j('body').hasClass('vertical_menu_enabled')) {
            ...
            if (!$j('header.page_header').hasClass('transparent')) {
                if ($j('[data-mkd_id="' + $target + '"]').offset().top - (header_height + content_menu_top_add + logo_height / 2 + 20) <= scroll_amount_for_fixed_hiding) {
                    scrollToAmount = $j('[data-mkd_id="' + $target + '"]').offset().top - content_menu_top_add - header_height - logo_height / 2 - 20 - paspartuScrollAdd
                } else {
                    scrollToAmount = $j('[data-mkd_id="' + $target + '"]').offset().top - content_menu_top_add - min_header_height_fixed_hidden - 20 - paspartuScrollAdd
                }
            } else {
                scrollToAmount = $j('[data-mkd_id="' + $target + '"]').offset().top - paspartuScrollAdd
            }
            ...
            if (!$j('header.page_header').hasClass('transparent')) {
                if (sticky_amount >= $j('[data-mkd_id="' + $target + '"]').offset().top) {
                    scrollToAmount = $j('[data-mkd_id="' + $target + '"]').offset().top + 1 - paspartuScrollAdd
                } else {
...
function initSocialIconHover() {
    ...
    if ($j('.mkd_social_icon_holder').length) {
        $j('.mkd_social_icon_holder').each(function() {
            ...
            if (hover_style !== "") {
                if ($j(this).find('.mkd_icon_stack .social_icon').length) {
                    $j(this).find('.mkd_icon_stack').hover(function() {
                ...
                if (typeof hover_background_color !== 'undefined' || typeof hover_border_color !== 'undefined' || typeof hover_color !== 'undefined') {
                    $j(this).hover(function() {
                        ...
                        if (typeof hover_color !== 'undefined') {
                            $j(this).find('i, span:not(.animation_overlay)').attr('style', function() {
...
function initIconTextHover() {
    ...
    if ($j('.mkd_icon_with_title').length) {
        $j('.mkd_icon_with_title').each(function() {
            ...
            $j(this).find('.icon_holder_inner').hover(function() {
...
function initElementsHolderBorderAnimation() {
    ...
    elementsHolder.each(function() {
        ...
        $j(this).find('.mkd_borderline_drawing div:nth-child(odd)').css({
            'background-color': color,
            'height': height + 'px'
        });
        $j(this).find('.mkd_borderline_drawing div:nth-child(even)').css({
            'background-color': color,
            'width': height + 'px'
        });
        $j(this).appear(function() {
...
function initVerticalSliderWithTextOver() {
    ...
    if ($j('.vertical_slider_with_text_over').length) {
        ...
        var headerHeight = $j('header.page_header').height();
        $j('.vertical_slider_with_text_over').height($window_height - headerHeight - 100).animate({
            opacity: 1
        }, 300);
        ...
        $j('.post_list').each(function() {
            ...
            if ($j(this).find('li').length) {
                $j(this).find('li').each(function() {
                    ...
                    $j(this).find('a.qbutton_with_icon').hover(function() {
                        if ($j(this).find('i').length) {
...
function imageStack() {
    ...
    if ($j('.image_stack').length > 0) {
        $j('.image_stack').each(function() {
            ...
            $j(this).find('.image').css({
                'height': ($j(this).outerHeight()) + 'px'
            });
            $j(this).find('.image.inner').css({
                'height': ($j(this).outerHeight() - 40) + 'px'
            });
            $j(this).find('.image.outer').css({
                'height': ($j(this).outerHeight() - 90) + 'px'
            });
            $j(this).appear(function() {
        ...
        mkdIF.position = function() {
            mkdIF.container.each(function(k) {
                ...
                mkdIF.side_images[k].each(function(i) {
                    ...
                    if (scroll < entrance) {
                        pos = 'above'
                    } else if (scroll >= entrance && scroll <= exit) {
                        pos = 'in'
                    } else if (scroll > exit) {
                        pos = 'below'
                    }
