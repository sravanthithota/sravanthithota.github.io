...
c.afterRender.call(f);ta();if(!c.animateAnchor&&(a=k.location.hash.replace("#","").split("https://burst.mikado-themes.com/")[0],a.length)){var b=d('[data-anchor="'+a+'"]');b.length&&(c.autoScrolling?x(b.position().top):(x(0),w.scrollTop(b.position().top)),J(a,null),d.isFunction(c.afterLoad)&&c.afterLoad.call(b,a,b.index(".fp-section")+1),b.addClass("active").siblings().removeClass("active"))}Aa();l.on("load",function(){var a=k.location.hash.replace("#","").split("https://burst.mikado-themes.com/"),b=a[0],a=a[1];b&&Z(b,a)})});var da,ea,T=!1;l.on("scroll",ca);
